...
public class Wolf extends Predator implements Resident {
    ...
    public Wolf(String name, String icon, double weight, int maxQuantityPerCell, int movementSpeed, double foodRequiredForSatiation, Map<String, Integer> eatingRiskMap) {
